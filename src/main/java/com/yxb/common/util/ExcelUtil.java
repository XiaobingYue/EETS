...
public class ExcelUtil<T> {
    ...
    public void getExcelAsTitle(OutputStream out, String title, List<T> dataset, String[] headers, String pattern) throws Exception {
       ...
       /* font2.setBoldweight(HSSFFont.BOLDWEIGHT_NORMAL);*/
        ...
        // 设置注释内容
        comment.setString(new HSSFRichTextString("表头"));
        // 设置注释作者，当鼠标移动到单元格上是可以在状态栏中看到该内容.
        comment.setAuthor("yxb");
