 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="email" value="${loginMember.email}" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
	...
	<script>
        ...
        function doNext() {
        	var email = $("#email");
        	if ( email.val() == "" ) {
        		layer.msg("邮箱地址不能为空，请输入", {time:1000, icon:5, shift:6});
        		return;
        	}
        	...
        	$.ajax({
        		...
        		success : function(result) {
        			if ( result.success ) {
        				...
        				layer.msg("邮箱验证码发送失败，请重新操作", {time:1000, icon:5, shift:6});
        			}
        		}
        	});
        }
