...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/manager/cert/add.htm'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
	...
	<script src="${APP_PATH}/script/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function pageQuery(pageno) {
            	...
            	$.ajax({
            		url : "${APP_PATH}/manager/cert/pageQuery.do",
            		type : "POST",
            		data : obj,
            		beforeSend : function() {
            			...
            			if ( result.success ) {
            				...
            				$.each(certList, function(i, cert){
             				   ...
             				   content = content +  '<tr>';
          					   ...
          					   content = content +  '      <button type="button" onclick="window.location.href=\'${APP_PATH}/manager/cert/edit.htm?pageno='+pageObj.pageno+'&id='+cert.id+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
            ...
            function deleteUser(id, name) {
    			layer.confirm("删除账号为"+name+"资质, 是否继续？",  {icon: 3, title:'提示'}, function(cindex){
    				// 删除数据
    				$.ajax({
    					url : "${APP_PATH}/manager/cert/delete.do",
    					type : "POST",
    					data  : {
    						id : id
    					},
            ...
            function deleteUsers() {
            	...
            	if ( checkBox.length == 0 ) {
        			...
        			layer.confirm("删除选择的资质数据, 是否继续？",  {icon: 3, title:'提示'}, function(cindex){
        				...
        				$.ajax({
        					url : "${APP_PATH}/manager/cert/deletes.do",
        					type : "POST",
        					data  : obj,
        					success : function(result) {
        						if ( result.success ) {
