                ...
                <div class="panel-body">
                    <form id="roleForm" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="rolename" value="${role.roleName}"
                                   placeholder="请输入角色名称">
                        </div>
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        // 提交表单
        $.ajax({
            url: "${APP_PATH}/roleController/modifyRole.do",
            type: "POST",
            data: {
            ...
            success: function (result) {
                ...
                if (result.success) {
                    layer.msg("角色信息修改成功", {time: 1000, icon: 6}, function () {
                        window.location.href = "${APP_PATH}/roleController/toRoleList.do?pageNo=${param.pageNo}";
                    });
                } else {
