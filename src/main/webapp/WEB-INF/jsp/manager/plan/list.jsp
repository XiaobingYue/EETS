        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" Plan="form" style="float:left;">
                        ...
                        <button type="button" class="btn btn-warning" onclick="queryPlan()"><i
...
<script type="text/javascript">
    ...
    initUpload("file", '${APP_PATH}/planController/uploadPdf.do');
    ...
    $("#file").on("fileuploaded", function (event, data, previewId, index) {
        ...
        if (data.response.success == true) {
            ...
            window.location.href = "${APP_PATH}/planController/toIndex.do"
            //$(".close").click();
        } else {
    ...
    function pageQuery(pageNo) {
        ...
        $.ajax({
            url: "${APP_PATH}/planController/queryListByPage.do",
            type: "POST",
            data: obj,
            beforeSend: function () {
            ...
            success: function (result) {
                ...
                if (result.success) {
                    ...
                    $.each(planList, function (i, plan) {
                        ...
                        content = content + '  <td><input type="checkbox" value="' + plan.id + '"></td>';
                        content = content + '  <td>' + plan.name + '</td>';
                        content = content + '  <td>' + plan.version + '</td>';
                        content = content + '  <td>' + plan.grade + '</td>';
    ...
    function allSel(obj) {
        ...
        var PlanBox = $("tbody :checkbox");

        $.each(PlanBox, function (i, n) {
            n.checked = flg;
        });
    }
    ...
    function deletePlans() {
        ...
        if (checkBox.length == 0) {
            ...
            layer.confirm("删除选择的角色数据, 是否继续？", {icon: 3, title: '提示'}, function (cindex) {
                ...
                $.ajax({
                    url: "${APP_PATH}/manager/Plan/deletes.do",
                    type: "POST",
                    data: obj,
                    success: function (result) {
                        if (result.success) {
