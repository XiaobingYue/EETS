        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="reqForm" role="form" method="post" action="${APP_PATH}/graduationReqController/editIndexPoint.do">
                        <div class="form-group">
                        <label>指标点编号</label>
                        <input type="text" class="form-control" id="code" name="code"
                               placeholder="请输入名称" value="${code}" onblur="ifHaveCode(this)">
                </div>
                        <div class="form-group">
                            <label>指标点名称</label>
                        ...
                        <c:forEach items="${indexPointList}" var="indexPoint">
                            <div class="form-group">
                                <label>${indexPoint.courseName}</label>
                                <input type="hidden" name="idList" value="${indexPoint.id}">
                                <input type="text" class="form-control" name="scoreList"
                                       placeholder="请输入分数" value="${indexPoint.score}">
                            </div>
                        </c:forEach>
        ...
        $("#reqForm").ajaxSubmit({
            ...
            success: function (result) {
                ...
                if (result.success) {
                    ...
                    layer.msg("保存失败"+result.data, {time: 1000, icon: 5, shift: 6});
                }
            }
        });
    });
