        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="reqForm" role="form" method="post" action="${APP_PATH}/graduationReqController/add.do">
                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker show-tick form-control" id="professionId"
                                    name="professionId" data-live-search="true">
                        ...
                        <div class="form-group">
                            <label>所涵课程</label>
                            <select class="selectpicker show-tick form-control" id="courseIdList"
                                    name="courseIdList" data-live-search="true" multiple>
