...
<button type="button" class="btn btn-primary" style="float:right;margin-left:10px;" onclick="window.location.href='${APP_PATH}/userController/toAddUser.do'"><i class="glyphicon glyphicon-plus"></i> 单个添加</button>
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/userController/toMultiAddUser.do'"><i class="glyphicon glyphicon-log-in"></i> 批量导入</button>
<br>
 <hr style="clear:both;">
